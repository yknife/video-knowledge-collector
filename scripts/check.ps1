...
try {
    npm.cmd exec -- vitest run src/plugins/video-knowledge/api.test.ts src/plugins/video-knowledge/wiki-markdown.test.tsx src/plugins/video-knowledge/chat-context.test.ts src/app/session/hooks/use-session-actions.test.tsx src/app/session/hooks/use-route-resume.test.tsx electron/bootstrap-runner.test.ts scripts/write-build-stamp.test.mjs
